...
# TODO send log from converter class to text box gui
...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.text_ctrl_3.AppendText(
            "R3D to ProRes Proxy Maker | BETA VERSION, for testing only \n\n Batch convert RED .r3d files to ProRes proxies. Only works on folders at the moment.  \n\n The latest Redcine-x Pro version needs to be installed. \nProxy output format: Full HD ProRes LT   \n\n Software provided as is, make a back-up before running this. Use at your own risk. \n Author: info@pieterboerboom.nl \n\n\n")
        # end wxGlade
